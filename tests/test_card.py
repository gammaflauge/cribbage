...
class TestCard(unittest.TestCase):
    ...
    def test_run_count(self):
        ...
        self.assertEqual(Card.run_count(self.hand_67899), 8)
        self.assertEqual(Card.run_count(self.hand_Q9T8J), 5)

    def test_score_hand(self):
        self.assertEqual(Card.score_hand(self.hand_5555), 20)
        self.assertEqual(Card.score_hand(self.hand_6789_suited), 12)
        self.assertEqual(Card.score_hand(self.hand_77889), 24)
